...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 640" font-family="'Microsoft YaHei','PingFang SC',sans-serif">
  ...
  <text x="171" y="124" text-anchor="middle" font-size="10" fill="#93c5fd">Module Configuration Metamodel</text>
  ...
  <g transform="translate(56, 442)">
    ...
    <text x="55" y="30" text-anchor="middle" font-size="9" fill="#94a3b8">Telecom Module</text>
    ...
    <text x="179" y="74" text-anchor="middle" font-size="9" fill="#94a3b8">OLT Module</text>
  </g>
