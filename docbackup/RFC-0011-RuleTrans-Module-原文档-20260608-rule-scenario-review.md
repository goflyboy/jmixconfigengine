...
public final class PromptBuilder {
    ...
    public String buildModuleStage2Prompt(
            ModulePromptView view,
            String naturalLanguage);
...
| 2 | 实现 `RuleContext`、`PartCategoryRuleContext`、`ModuleRuleContext`、`RuleContextFactory` | P0 | 待开始 |
...
| 5 | 实现 `CategoryIdentifier`，完成模块级 Stage1 分类识别与校验 | P0 | 待开始 |
