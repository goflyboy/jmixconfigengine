...
public enum ComparisonOperator {
    EQUAL("==") {
        @Override
        public void applyConstraint(AlgCPModelImpl cpModel, PartAlgCPLinearExprImpl expr, int value) {
     ...
     * @param value   比较值
     */
    public abstract void applyConstraint(AlgCPModelImpl cpModel, PartAlgCPLinearExprImpl expr, int value);
