...
static public class Perf20ParasConstraint extends ConstraintAlgImpl {
    ...
    @ParaAnno(options = {"op00301", "op00302", "op00303", "op00304", "op00305", "op00306", "op00307", "op00308", "op00309", "op00310"})
    private ParaVar P003;
    @ParaAnno(options = {"op00401", "op00402", "op00403", "op00404", "op00405", "op00406", "op00407", "op00408", "op00409", "op00410"})
    private ParaVar P004;
    @ParaAnno(options = {"op00501", "op00502", "op00503", "op00504", "op00505", "op00506", "op00507", "op00508", "op00509", "op00510"})
    private ParaVar P005;
    @ParaAnno(options = {"op00601", "op00602", "op00603", "op00604", "op00605", "op00606", "op00607", "op00608", "op00609", "op00610"})
    private ParaVar P006;
    @ParaAnno(options = {"op00701", "op00702", "op00703", "op00704", "op00705", "op00706", "op00707", "op00708", "op00709", "op00710"})
    private ParaVar P007;
    @ParaAnno(options = {"op00801", "op00802", "op00803", "op00804", "op00805", "op00806", "op00807", "op00808", "op00809", "op00810"})
    private ParaVar P008;
    @ParaAnno(options = {"op00901", "op00902", "op00903", "op00904", "op00905", "op00906", "op00907", "op00908", "op00909", "op00910"})
    private ParaVar P009;
    @ParaAnno(options = {"op01001", "op01002", "op01003", "op01004", "op01005", "op01006", "op01007", "op01008", "op01009", "op01010"})
    private ParaVar P010;
    @ParaAnno(options = {"op01101", "op01102", "op01103", "op01104", "op01105", "op01106", "op01107", "op01108", "op01109", "op01110"})
    private ParaVar P011;
    @ParaAnno(options = {"op01201", "op01202", "op01203", "op01204", "op01205", "op01206", "op01207", "op01208", "op01209", "op01210"})
    private ParaVar P012;
    @ParaAnno(options = {"op01301", "op01302", "op01303", "op01304", "op01305", "op01306", "op01307", "op01308", "op01309", "op01310"})
    private ParaVar P013;
    @ParaAnno(options = {"op01401", "op01402", "op01403", "op01404", "op01405", "op01406", "op01407", "op01408", "op01409", "op01410"})
    private ParaVar P014;
    @ParaAnno(options = {"op01501", "op01502", "op01503", "op01504", "op01505", "op01506", "op01507", "op01508", "op01509", "op01510"})
    private ParaVar P015;
    @ParaAnno(options = {"op01601", "op01602", "op01603", "op01604", "op01605", "op01606", "op01607", "op01608", "op01609", "op01610"})
    private ParaVar P016;
    @ParaAnno(options = {"op01701", "op01702", "op01703", "op01704", "op01705", "op01706", "op01707", "op01708", "op01709", "op01710"})
    private ParaVar P017;
    @ParaAnno(options = {"op01801", "op01802", "op01803", "op01804", "op01805", "op01806", "op01807", "op01808", "op01809", "op01810"})
    private ParaVar P018;
    @ParaAnno(options = {"op01901", "op01902", "op01903", "op01904", "op01905", "op01906", "op01907", "op01908", "op01909", "op01910"})
    private ParaVar P019;
    @ParaAnno(options = {"op02001", "op02002", "op02003", "op02004", "op02005", "op02006", "op02007", "op02008", "op02009", "op02010"})
    ...
    protected void Rule21() {
        ...
        // model.addEquality((IntVar)PT001.qty, 3).onlyEnforceIf(condition1.not(), condition2.not());
    }
    ...
    protected void Rule22() {
        ...
        // model.addEquality((IntVar)PT002.qty, 3).onlyEnforceIf(condition1.not(), condition2.not());
    }
    ...
    protected void Rule23() {
        ...
        // model.addEquality((IntVar)PT003.qty, 3).onlyEnforceIf(condition1.not(), condition2.not());
    }
    ...
    protected void Rule24() {
        ...
        // model.addEquality((IntVar)PT004.qty, 3).onlyEnforceIf(condition1.not(), condition2.not());
    }
    ...
    protected void Rule25() {
        ...
        // model.addEquality((IntVar)PT005.qty, 3).onlyEnforceIf(condition1.not(), condition2.not());
    }
}
//---------------模型的定义end----------------------------------------
