...
public class DynScheduleTest extends ModuleSecnarioTestBase {
    ...
    static public class DynScheduleConstraint extends ConstraintAlgImpl {
        ...
        protected void Rule02() {
            ...
            // model.addEquality((IntVar)P21.value, P21.getParaOptionByCode("op211").codeId).onlyEnforceIf(p21InOp211);
            // model.addEquality((IntVar)P21.value, P21.getParaOptionByCode("op212").codeId).onlyEnforceIf(p21InOp212);
           ...
           // model.addBoolAnd(new BoolVar[]{p21InOp211.not(), p21InOp212.not()}).onlyEnforceIf(p21InFirstGroup.not());
            ...
            // model.addEquality((IntVar)P21.value, P21.getParaOptionByCode("op213").codeId).onlyEnforceIf(p21InOp213);
            // model.addEquality((IntVar)P21.value, P21.getParaOptionByCode("op214").codeId).onlyEnforceIf(p21InOp214);
            ...
            //model.addBoolAnd(new BoolVar[]{p21InOp213.not(), p21InOp214.not()}).onlyEnforceIf(p21InSecondGroup.not());
    ...
    public void testCase1_InferP0P11FromPT1Qty() {
        // Test case 1: Infer P0.value and P11.value from PT1.qty with constraints Rule01 and Rule11
        inferParas("PT1", 2);
    ...
    public void testCase2_InferP0P21FromPT2Qty() {
        // Test case 2: Infer P0.value and P21.value from PT2.qty with constraints Rule02 and Rule21
        inferParas("PT2", 4);
