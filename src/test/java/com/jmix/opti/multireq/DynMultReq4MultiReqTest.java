...
public class DynMultReq4MultiReqTest extends ModuleScenarioTestBase {
    ...
    static public class DynMultReqMultiInstConstraint extends ConstraintAlgBase {
        ...
        private void logicB2() {
            ...
            PartAlgCPLinearExprImpl totalCapacity = sum4Quantity("Capacity",
                    "").name("totalCapacity");
            // 如果是容量需求
            ...
            if (drive.sumSumPara("Capacity").hasInput()) {
                ...
                PartAlgCPLinearExprImpl highCapacityExpr = sum4Selected("Capacity", "")
                ...
                PartAlgCPLinearExprImpl excessQuantityExpr = sum4Quantity("", "")
                ...
                PartAlgCPLinearExprImpl totalQuantity = sum4Quantity("",
                        "").name("totalQuantity");
